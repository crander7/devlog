...
import { Calendar, Clock, Edit2, Plus, Tag, Trash2 } from 'lucide-react';
...
import type { WorkLogEntry } from '@/types/electron';
...
export function WorkLog() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (editingLog) {
                await window.electronAPI.updateWorkLog(editingLog.id, logData);
            } else {
                await window.electronAPI.createWorkLog(logData);
            }
